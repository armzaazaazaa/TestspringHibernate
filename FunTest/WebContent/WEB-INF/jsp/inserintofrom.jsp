					...
					<tbody>
						...
						<tr>
							...
							<td>
									...
									<th>
										<button onclick="myFunction(<%=userlist.get(i).getId()%>,'<%=userlist.get(i).getEmail()%>','<%=userlist.get(i).getPasswort()%>');"   type="button" class="btn btn-info"> edit </button>
									</th>	
									<th>
									...
									<th>
										<form  id="viewdatauser" action="viewdatauser" method="post" >
											<input id="numid" name="numid" value="<%=userlist.get(i).getId()%>" type="hidden">
											<button type="submit" class="btn btn-secondary">ดูข้อมูล</button>
										</form>
									</th>
